...
export function Header() {
  ...
  if (routes['/submission']) {
    navigationKbarItems.push({
      id: "submission",
      name: "Submission",
      section: "Navigation",
      shortcut: [],
      keywords: "submission, submission page",
      href: "/submission",
      icon: "changelog",
    });
  }
  ...
  if (routes['/showcase']) {
    navigationKbarItems.push({
      ...
      section: "Navigation",
      shortcut: [],
      keywords: "showcase, showcase page",
      href: "/showcase",
      icon: "image",
    });
  }
      ...
      <Flex as="header" background="page" horizontal="center" position="sticky" zIndex={9} fillWidth vertical="center" paddingY="12" paddingRight="16" paddingLeft="12" borderBottom="neutral-alpha-medium">
        <Row maxWidth={layout.header.width} vertical="center" horizontal="between" gap="l">
          <Row fillWidth vertical="center" gap="8">
            ...
            <Logo wordmark="/trademarks/logo.png" size="s" href="/"/>
          </Row>
          ...
          <Row fillWidth horizontal="end" gap="8" data-border="rounded">
            <Button prefixIcon="rocket" href="https://github.com/charisprod/charlink/archive/refs/heads/main.zip" size="s">
              Download Template
            </Button>
          </Row>
        </Row>
